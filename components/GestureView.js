...
export default class GestureView extends Component {
  ...
  componentWillMount () {
    this._panResponder = PanResponder.create({
      ...
      onPanResponderMove: (...args) => this.onSwipeMove(...args)
    })
  }

  onSwipeMove = (pan, gesture) => {
    ...
    if (this.props.onSwipeRight && this.isInsideQuadrant(this.state.quadrants, 'right', angle)) {
      
      this.props.onSwipeMoving(distance, angle)
    }
  }
